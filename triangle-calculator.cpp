...
void main()
{
    double A = 0, B = 0, C = 0, Ar = 0, Br = 0, Cr = 0, a = 0, b = 0, c = 0, ans = 0, pi = 3.14159, inf_angle[3], inf_angle_radian[3], inf_side[3];
    ...
    else if (A == 90 || B == 90 || C == 90)
    {
        ...
        if ((x == "a" || x == "b" || x == "c") && (A == 90 || B == 90 || C == 90) && inf_sides_present == 2)
        {
            if (A == 90)
            {
                if (x == "a" && b != 0 && c != 0)
        ...
        else if (inf_angles_present >= 1 && inf_sides_present == 1)
        {
            if (A != 90)
            {
                if (x == "a")
